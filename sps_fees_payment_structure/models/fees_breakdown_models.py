...
1. FeesCategory:
   ...
   - grade: ForeignKey relationship with the Grade model.
...
4. UniformAndBooksFeeCategory:
   ...
   - category: ForeignKey relationship with the FeesCategory model.
   - grades: Many-to-Many relationship with the Grade model.
...
class FeesCategory (models.Model):
    ...
    grade = models.ForeignKey("sps_core.Grade", on_delete=models.CASCADE)
